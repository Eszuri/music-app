...
export function NoFolderEmptyState({lang, onPickFolder, accentColor}: {lang: Lang; onPickFolder: () => void; accentColor: string}) {
    ...
    return (
        <div className="flex-1 flex flex-col items-center justify-center p-8 text-center">
            ...
            <h2 className="text-2xl font-semibold text-zinc-200 mb-2">{t(lang, 'empty.welcomeTitle')}</h2>
...
export function EmptyFolderState({lang, folder}: {lang: Lang; folder: string}) {
    return (
        <div className="flex flex-col items-center justify-center text-center max-w-md">
            ...
            <h3 className="text-lg font-semibold text-zinc-200 mb-1.5">{t(lang, 'empty.folderEmptyTitle')}</h3>
